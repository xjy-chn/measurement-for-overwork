...
if __name__=="__main__":
    ...
    for year in range(2012, 2021):
        ...
        for day in days:
            ...
            with h5py.File(rf'./zonal/{radius}x{radius}/city_weighted/{year}/{day}.h5','r') as f:
                x=f['data']['x'][:]
                y = f['data']['y'][:]
                dummy[x,y]= f['data']['dummy'][:]
            arcpy.sa.ZonalStatisticsAsTable(rf"./country84.shp",
                                            "FID", arcpy.NumPyArrayToRaster(dummy, arcpy.Point(70, 10),
                                                                            x_cell_size=0.004166666666666667,
                                                                            y_cell_size=0.004166666666666667,
                                                                            value_to_nodata=200),
                                            rf"F:\overwork\daily_zontal.gdb\deep2_sfn{year}{day}", "DATA",
