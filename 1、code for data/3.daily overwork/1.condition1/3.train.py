...
def train(net, train_iter, loss, optimizer, metric_train,metric_test,
...
if __name__ == "__main__":
    ...
    for i in range(0, epochs):
        ...
        for d in range(num_of_files):
            ...
            if i == 0 & d == 0:
                metric_train,metric_test, device, optimizer, l_train,l_test, timer = train(net3, train_loader, loss=loss,
                ...
                metric_train, metric_test, device, optimizer, l_train, l_test, timer = train(net3, train_loader,
                                                                                                  loss=loss,
                                                                                                  optimizer=optimizer,
                                                                                                  device=device,
                                                                                                  metric_train=metric_train,
