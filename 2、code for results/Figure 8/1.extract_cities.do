...
save "F:\日度夜间灯光\原始数据\result\日度分区统计\deep\w劳动争议元化解试点城市数据.dta",replace
restore
...
tsline  sigma,xsize(20) ysize(8) xlabel(#19,angle(45)) xtitle(date) title("(b) Unweighted")
addplot:,yline(9.62,lc(red) lp(dash) lwidth(1)) norescaling 
